        ...
        try:
            results.append(
                InlineQueryResultArticle(
                    ...
                    reply_markup=InlineKeyboardMarkup(resize_keyboard=True).add(InlineKeyboardButton(text='🍿 Смотреть',url=f'http://bot.animepoint.cc/id/{i.kodik_id}')).add(InlineKeyboardButton(text=text,callback_data=f'{callback_data}#{i.kodik_id}')).add(InlineKeyboardButton(text='🔎 Поиск по названию',switch_inline_query_current_chat="#all ")),
