...
----------------------------------------------------------------------
    @anipointbot - Самая большая база с аниме мультфильмами и сериалами."""
        else:
            ...
            self.imdb_rating: str = "IMDb: "
            self.kinopoisk_rating: str = "| КиноПоиск: "
            self.description: str = """Описание:\n
----------------------------------------------------------------------
    @anipointbot - Самая большая база с аниме мультфильмами и сериалами."""
...
class Searcher:
    ...
    async def search(
        self, phraze, types: str = "anime-serial, anime"
    ...
    async def search_imdb_id(
        self, link, types: str = "anime-serial"
    ):  # поиск по ссылке imdb
    ...
    async def search_kinopoisk_id(
        self, link, types: str = "anime-serial"
    ):  # поиск по ссылке kinopoisk
