...
favorites_table = sqlalchemy.Table(
    ...
    sqlalchemy.Column(
        "right_id", sqlalchemy.Integer, sqlalchemy.ForeignKey("anime.id")
    ),
)
...
class Users(SqlAlchemyBase):
    ...
    favorites = orm.relationship(
        "Anime", secondary=favorites_table, back_populates="user"
    )
...
class Anime(SqlAlchemyBase, SerializerMixin):
    ...
    user = orm.relationship(
        "Users", secondary=favorites_table, back_populates="favorites"
    )
